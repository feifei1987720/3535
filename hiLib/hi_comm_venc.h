...
{
    BASE_IDRSLICE = 0,                  //baseIDR
    BASE_PSLICE_REFBYBASE,              //basePbase
    BASE_PSLICE_REFBYENHANCE,           //basePenhance
    ENHANCE_PSLICE_REFBYENHANCE,        //enhancePenhance
    ENHANCE_PSLICE_NOTFORREF,           //enhanceP
    ENHANCE_PSLICE_BUTT
} H264E_REF_TYPE_E;
...
typedef struct hiVENC_H264_CAPABILITY_S
{
    ...
    HI_U8   u8BaseAttr      ;   /*bit0bit5 denote MBAFF, PAFFB SLICEFMO ASOPARTITION  */
