...
#define I2C_CTRL_REG      IO_ADDRESS(I2C_ADRESS_BASE + 0x000)
#define I2C_COM_REB       IO_ADDRESS(I2C_ADRESS_BASE + 0x004)
#define I2C_ICR_REG       IO_ADDRESS(I2C_ADRESS_BASE + 0x008)
#define I2C_SR_REG        IO_ADDRESS(I2C_ADRESS_BASE + 0x00C)
#define I2C_SCL_H_REG     IO_ADDRESS(I2C_ADRESS_BASE + 0x010)
#define I2C_SCL_L_REG     IO_ADDRESS(I2C_ADRESS_BASE + 0x014)
#define I2C_TXR_REG       IO_ADDRESS(I2C_ADRESS_BASE + 0x018)
#define I2C_RXR_REG       IO_ADDRESS(I2C_ADRESS_BASE + 0x01C)
