...
HI_S32 HI_MPI_VPSS_GetChnFrame(VPSS_GRP VpssGrp, VPSS_CHN VpssChn,  VIDEO_FRAME_INFO_S *pstVideoFrame);
...
/*set&get vpss field information.*/
HI_S32 HI_MPI_VPSS_SetGrpField(VPSS_GRP VpssGrp, VIDEO_FIELD_E enCapSel);
HI_S32 HI_MPI_VPSS_GetGrpField(VPSS_GRP VpssGrp, VIDEO_FIELD_E *enCapSel);
...
HI_S32 HI_MPI_VPSS_GetRegionLuma(VPSS_GRP VpssGrp,VPSS_REGION_INFO_S *pstRegionInfo,
