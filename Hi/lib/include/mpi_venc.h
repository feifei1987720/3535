...
HI_S32 HI_MPI_VENC_SetH264eRefMode(VENC_CHN VeChn, VENC_H264_REF_MODE_E enRefMode);
HI_S32 HI_MPI_VENC_GetH264eRefMode(VENC_CHN VeChn, VENC_H264_REF_MODE_E *penRefMode);

HI_S32 HI_MPI_VENC_SetH264eRefParam(VENC_CHN VeChn, const VENC_PARAM_H264_REF_S *pstRefParam);
HI_S32 HI_MPI_VENC_GetH264eRefParam(VENC_CHN VeChn, VENC_PARAM_H264_REF_S *pstRefParam);
...
HI_S32 HI_MPI_VENC_SetH264eIdrPicId( VENC_CHN VeChn, VENC_H264_IDRPICID_CFG_S* pstH264eIdrPicIdCfg );
HI_S32 HI_MPI_VENC_GetH264eIdrPicId( VENC_CHN VeChn, VENC_H264_IDRPICID_CFG_S* pstH264eIdrPicIdCfg );
