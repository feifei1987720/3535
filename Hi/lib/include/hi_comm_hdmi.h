...
{
    HI_HDMI_SND_INTERFACE_I2S,              /**<I2SInter-IC Sound */
    HI_HDMI_SND_INTERFACE_SPDIF,            /**<SPDIFSony/Philips Digital Interface */
    HI_HDMI_SND_INTERFACE_HBR,              /**<SPDIFSony/Philips Digital Interface */
...
typedef struct hiUNF_HDMI_ATTR_S
{
    ...
    HI_HDMI_VIDEO_MODE_E    enVidOutMode;        /**< HDMI output video output mode.VIDEO_MODE_YCBCR444VIDEO_MODE_YCBCR422VIDEO_MODE_RGB444 */
...
{
    HI_HDMI_VIDEO_MODE_E    enVidInMode;        /**< HDMI output video input mode.VIDEO_MODE_YCBCR444VIDEO_MODE_RGB444 */
}HI_HDMI_PARAM_S;
...
#define CEC_OPCODE_TEXT_VIEW_ON                   0X0D  /**< <Text View On> As <Image View On>, but should also remove any text, menus and PIP windows from the TVs display. */
...
#define CEC_OPCODE_DECK_CONTROL                   0X42  /**< <Deck Control> Used to control a devices media functions. */
#define CEC_OPCODE_DECK_STATUS                    0X1B  /**< <Deck Status> Used to provide a decks status to the initiator of the <Give Deck Status> message. */
...
#define CEC_OPCODE_TUNER_STEP_DECREMENT           0X06  /**< <Tuner Step Decrement> Used to tune to next lowest service in a tuners service list. Can be used for PIP. */
#define CEC_OPCODE_TUNER_STEP_INCREMENT           0X05  /**< <Tuner Step Increment> Used to tune to next highest service in a tuners service list. Can be used for PIP. */
...
#define CEC_OPCODE_REPORT_AUDIO_STATUS            0X7A  /**< <Report Audio Status> Reports an amplifiers volume and mute status */
...
typedef struct hiUNF_HDMI_CEC_STATUS_S
{
    ...
    HI_U8   u8Network[HI_CEC_LOGICALADD_BUTT];    /**< CEC's net work1:this device can answer cec command */
